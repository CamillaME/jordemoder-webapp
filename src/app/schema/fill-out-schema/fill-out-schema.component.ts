...
export class FillOutSchemaComponent implements OnInit {
  ...
  constructor(private db: AngularFirestore, private profileService: ProfileService, private schemaService: SchemaService, private route: ActivatedRoute, private router: Router) {
  ...
  addNewNote(id) {
    this.router.navigateByUrl('ny-note' + "/erfaringsskema/" + id);
